...
const PersonAppearanceContent = ({ data, numberOfContent, excludeFirst, movieLink, tvShowLink, movieAndTvShowLink }) => {
  ...
  return (
    <div className='flex flex-col justify-center'>
      <div className='ss:grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6'>
        {data.pages.map((page) =>
          page.cast.slice(startFrom, numberOfContent).map((content, i) => (
...
export default PersonAppearanceContent