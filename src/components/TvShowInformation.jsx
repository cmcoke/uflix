        ...
        <div className="information-text-content">
          ...
          <div className="flex flex-col items-center sm:items-start sm:flex-row">
            ...
            <div className="flex items-center font-poppins mb-5 md:mb-0 sm:mr-11 ">
              ...
              <p className="mx-2">{tvShowData?.vote_average ? (Math.round((tvShowData?.vote_average + Number.EPSILON) * 10) / 10).toString() : 'N/A'}</p>
              <p>IMDb Rating</p>
            </div>

            <div className="flex items-center font-poppins">
              <img src={popcorn} alt="Audience View" />
              <p className="mx-2">{(tvShowData?.popularity.toFixed() / 100).toString()} % </p>
              <p>Popularity</p>
            </div>
